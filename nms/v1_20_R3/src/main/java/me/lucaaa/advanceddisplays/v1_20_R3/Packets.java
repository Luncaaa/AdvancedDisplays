package me.lucaaa.advanceddisplays.v1_20_R3;
...
public class Packets implements PacketInterface {
    ...
    public void setText(int displayId, String textJSON, Player player) {
        ...
        List<SynchedEntityData.DataValue<?>> data = new ArrayList<>();
        data.add(SynchedEntityData.DataValue.create(new EntityDataAccessor<>(23, EntityDataSerializers.COMPONENT), Objects.requireNonNull(Component.Serializer.fromJson(textJSON))));
