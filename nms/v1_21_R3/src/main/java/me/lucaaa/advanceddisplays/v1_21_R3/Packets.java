...
public class Packets implements PacketInterface {
    ...
    private SynchedEntityData.DataValue<?> createDataValue(CraftPlayer cp, Metadata.DataPair<?> metadata) {
        ...
        return switch (metadata.data().type()) {
            ...
            case ART -> SynchedEntityData.DataValue.create(new EntityDataAccessor<>(id, EntityDataSerializers.PAINTING_VARIANT), CraftRegistry.bukkitToMinecraftHolder((Art) value, Registries.PAINTING_VARIANT));
