...
public class DisplayEditorItems {
    ...
    public final Item.StepItem SHADOW_RADIUS;
    public final Item.StepItem SHADOW_STRENGTH;

    public final Item.BooleanItem GLOW_TOGGLE;
    public final ColorItems.ColorPreview GLOW_COLOR_SELECTOR;

    public final Item.ClickableItem TELEPORT;
    public final Item.ClickableItem MOVE_HERE;
    public final Item.ClickableItem CENTER;

    public final Item.EnumItem BILLBOARD;
    public final Item.BooleanItem HITBOX_OVERRIDE;

    public final Item.ClickableItem CURRENT_VALUE;
