...
public class EditorItems {
    ...
    public EditorItems(BaseDisplay display) {
        ...
        switch (display.getType()) {
            ...
            case ITEM -> CURRENT_VALUE = GlobalItems.create(((ItemDisplay) display).getItem().getType(), "Display item", List.of("Changes the item that is being displayed"/*, "You must have an item in your cursor."*/), ((ItemDisplay) display).getItem().getType(), false, false, 0.0, 0.0);
