...
public class GlobalItems {
    public static Item.ClickableItem cancel(AdvancedDisplays plugin) {
        return getHead(plugin.cachedHeads.CANCEL.clone(), "&cCancel", List.of("&eGo back without saving"));
    }
    public static Item.ClickableItem done(AdvancedDisplays plugin) {
        return getHead(plugin.cachedHeads.DONE.clone(), "&aDone", List.of("&eGo back and save your changes"));
    }
