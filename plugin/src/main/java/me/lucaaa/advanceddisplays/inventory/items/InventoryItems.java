...
public class InventoryItems {
    ...
    public InventoryItems(BaseDisplay display) {
        ...
        YAW = new Item.StepItem(Material.SLIME_BALL, "Yaw", "Changes the display's yaw", display.getYaw(), 10.0, 1.0, true);
        PITCH = new Item.StepItem(Material.FIRE_CHARGE, "Pitch", "Changes the display's pitch", display.getPitch(), 10.0, 1.0, true);
        ...
        OPEN_GUI = new Item.ClickableItem(Material.NETHER_STAR, "Open editor GUI", List.of("Opens a GUI with more options", "to edit the display"), "(" + display.getType() + ") " + display.getName());
