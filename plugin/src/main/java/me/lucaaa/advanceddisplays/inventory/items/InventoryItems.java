...
public class InventoryItems {
    ...
    public static class DisplayItems extends InventoryItems {
        ...
        public DisplayItems(BaseDisplay display) {
            ...
            LEFT_ROTATION_ANGLE = new Item.StepItem(Material.MAGMA_CREAM, "Left Rotation Angle", "Changes the angle of the display's left rotation", Utils.round(Math.toDegrees(transformation.getLeftRotation().angle())), 10.0, 1.0, true);
            ...
            RIGHT_ROTATION_ANGLE = new Item.StepItem(Material.MAGMA_CREAM, "Right Rotation Angle", "Changes the angle of the display's right rotation", Utils.round(Math.toDegrees(transformation.getRightRotation().angle())), 10.0, 1.0, true);
